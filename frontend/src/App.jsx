...
function App() {
  ...
  useEffect(()=>{
    axios.get(`${backendURL}/api/getData`).then((e)=>{
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="relative overflow-hidden bg-gradient-to-r from-white via-gray-50 to-white text-black">
        ...
        <div className="relative container mx-auto px-6 py-20 text-center">
          ...
          <div className='flex items-center justify-center font-2xl' >
           
            Full-Stack Project Generator • Zero Configuration • Production Ready
            The Express Says: {data} 
          <div className='rounded-full h-5 w-5 bg-green-500 m-2 animate-pulse'></div>
          </div>
